...
This Rails 2.3.5 fork is by "Chuck Vose":http://chuckvose.com and is based on the fork by "Jay McGavren":http://jay.mcgavren.com
...
Bundler support has been added. There are some commented gems in the Gemfile for 
uploading to Heroku but otherwise it is a very small process. You will probably
need to `bundle install --relock` to get all the gems running. 
